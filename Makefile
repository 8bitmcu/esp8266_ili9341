...
MODULES		= driver lwip include user
EXTRA_INCDIR    = include

# libraries used in this project, mainly provided by the SDK
LIBS		= c gcc hal pp phy net80211 wpa main ssl lwip

# compiler flags using during compilation of source files
CFLAGS		= -Os -g -O2 -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH
